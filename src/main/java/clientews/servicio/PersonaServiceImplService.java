 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.adanyc.com.pe/", wsdlLocation = "http://localhost:9090/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.adanyc.com.pe/", "PersonaServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/PersonaServiceImplService/PersonaServiceImpl?wsdl");
    ...
    public PersonaServiceWs getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.adanyc.com.pe/", "PersonaServiceImplPort"), PersonaServiceWs.class);
    }
    ...
    public PersonaServiceWs getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.adanyc.com.pe/", "PersonaServiceImplPort"), PersonaServiceWs.class, features);
    }
